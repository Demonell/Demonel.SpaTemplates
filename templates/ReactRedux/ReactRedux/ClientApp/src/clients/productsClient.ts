...
export class ProductsClient {
     ...
     */
    get(id: number | null | undefined, name: string | null | undefined, productType: ProductType | null | undefined, materialName: string | null | undefined, skip: number | null | undefined, take: number | null | undefined, sort: string | null | undefined): Promise<TotalListOfProductVm> {
    ...
    /**
     * Создание продукта
     * @return Успех! Возвращает уникальный идентификатор созданного продукта
     */
